...
const navlink = (props) => {
    ...
    return <React.Fragment>
        ...
        <ul className={classes.Navlink}>
               <div className={classes.menu} onClick={setSideDrawer}><AiOutlineMenu style={{fontSize:"1.5em",color:"#fff"}}/></div>
                ...
                <NavLink className={classes.insurance} to="/insurance/supreme">Home</NavLink>
            ...
            {/* <NavLink className={classes.financial} to="/supreme/financial">Financial Wellbeing</NavLink> */}
            <NavLink className={classes.financial} to="/supreme/customer_service">Customer Service</NavLink>
            {/* </div> */}
                {props.hide && <div>
