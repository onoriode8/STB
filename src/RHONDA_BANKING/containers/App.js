...
import CustomerService from '../components/routes/customerService/customerService';
...
const App = props => {
    let content = <Switch>
                    ...
                    <Route path="/supreme/customer_service" exact component={CustomerService} />
                    <Redirect to="/auth" />
                  </Switch>
    if(props.login) {
        content = <Switch>
...
// from github respositiory
// …or push an existing repository from the command line
// git remote add origin https://github.com/onoriode8/STB.git
// git branch -M main
